    ...
    <form action={action} className="space-y-4">
      ...
      <div>
        <label className="block text-sm font-medium text-slate-700">
          Training type <span className="font-normal text-slate-400">(select at least one)</span>
        </label>
        <div className="mt-1 flex flex-wrap gap-4 rounded-md border border-slate-300 px-3 py-2 text-sm shadow-sm">
          <label className="flex items-center gap-1.5">
            <input type="checkbox" name="trainingType" value="pg" className="rounded border-slate-300" />
            Paraglider (PG)
          </label>
          <label className="flex items-center gap-1.5">
            <input type="checkbox" name="trainingType" value="ppg" className="rounded border-slate-300" />
            Powered Paragliding (PPG)
          </label>
          <label className="flex items-center gap-1.5">
            <input type="checkbox" name="trainingType" value="ppt" className="rounded border-slate-300" />
            Powered Paratrike (PPT)
          </label>
        </div>
      </div>
      <div>
